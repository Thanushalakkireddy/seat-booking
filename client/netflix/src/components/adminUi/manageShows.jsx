...
export default function ManageShows() {
    ...
    const fetchShows = async () => {
        try {
            const res = await axios.get("http://your-public-ip:5000/api/admin/viewShows",
        ...
        try {
            ...
            if (editId) {
                const res = await axios.patch(
                    `http://your-public-ip:5000/api/admin/editShow/${editId}`,
                    formData,
                    headers
                );
                ...
                const res = await axios.post(
                    "http://your-public-ip:5000/api/admin/addShow",
                    formData,
                    headers
                );
    ...
    const handleDelete = async (id) => {
        try {
            const res = await axios.delete(`http://your-public-ip:5000/api/admin/deleteShow/${id}`,
                { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } })
            setMessage(res.data.message);
            fetchShows();
        } catch (err) {
